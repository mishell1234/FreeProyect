...
export default function Home() {
  ...
  const imagenes = ["/fotoIcon.jpeg", "/fotoCarrusel1.jpeg"];
              ...
              onClick={() => setActiveCard( activeCard === 3 ? null : 3) }>
                <div className={`${activeCard === 3 ? "descripcionDetalleActivo" : ""}`}>
                  ...
                  <div className="">
                    ...
                    <p className={`descripcionInicioDetalle ${activeCard === 3 ? "active" : ""}`}>Durante mi tiempo en Inmobiliaria y Constructora OHF S.A.C., elaboré estados financieros, balances y puntos de equilibrio para evaluar proyectos. Participé en el desarrollo de planes
                    de negocio aplicando el modelo Canvas y automatizando la recolección y análisis de información mediante Node.js y Puppeteer. También realicé análisis financieros con TIR, VAN e indicadores financieros.<br/>
                    En Grupo Deltron S.A. como Auxiliar de Cobranzas, gestioné el registro de abonos de clientes, conciliaciones bancarias y pagos de documentos. Automatizé reportes de gestión de cobranzas usando VBA en Excel y propuse mejoras tecnológicas con JavaScript y HTML. Además, trabajé con plataformas digitales y sistemas internos como Oracle. <br/>
                    Posteriormente, fui trasladado al área de Calidad debido a mi desempeño destacado, donde continué automatizando reportes y procesos con Power BI y Python. Desarrollé scripts para detección facial con cámaras de seguridad y para la lectura masiva de PDFs, clasificando automáticamente cientos de archivos. 
                    Implementé dashboards integrales que facilitaron la toma de decisiones basada en datos. <br/>
                    </p>
                  </div>
                </div>
            </motion.div>
